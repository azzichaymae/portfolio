      ...
      <div className="mt-8 md:mt-0 md:ml-12 text-center md:text-left max-w-xl">
        ...
        <p className="mt-4 text-gray-600 leading-relaxed">
          <Trans i18nKey="AboutMe.description1">
            ...
            <span className="font-semibold">SUPMTI</span>. Skilled in React.js,
            Laravel, Django, SpringBoot, and MySQL, I build complete
            applications—from designing interfaces to managing data
            persistence—and enjoy turning ideas into functional, user-friendly
            solutions.
          </Trans>
        </p>
